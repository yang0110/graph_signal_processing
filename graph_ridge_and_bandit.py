...
plt.savefig(path+'random_model/'+'cum_regret_user_num_noise_thrs_%s_%s_%s'%(user_num, noise_level, thrs)+'.png', dpi=300)
plt.show()
...
plt.title('User num=%s, noise=%s, T=%s'%(user_num, noise_level, thrs), fontsize=12)
plt.legend(loc=0, fontsize=12)
plt.savefig(path+'random_model/'+'learing_error_user_num_noise_thrs_%s_%s_%s'%(user_num, noise_level, thrs)+'.png', dpi=300)
plt.show()
