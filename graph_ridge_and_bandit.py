...
plt.plot(l_cum_regret, 'y', label='LinUCB')
plt.plot(g_cum_regret, 'r', label='Cum Regret')
plt.legend(loc=0, fontsize=12)
plt.title('Cum regret', fontsize=12)
plt.show()

plt.figure(figsize=(5,5))
plt.plot(l_error_list, 'y', label='LinUCB')
plt.plot(g_error_list, 'r', label='Graph-ridge')
plt.legend(loc=0, fontsize=12)
plt.title('Learning Error', fontsize=12)
plt.show()
